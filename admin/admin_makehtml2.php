...
function viewFoot()
{
	...
	($endtime[0]+($endtime[1]-$starttime[1])-$starttime[0])."秒,共执行".$dsql->QueryTimes()."次数据查询</td></tr><tr><td align=\"center\"><a target=\"_blank\" href=\"http://www.seacms.la/\">Powered By SeaCms</a></td></tr></table></div>\n</body>\n</html>";
}
